...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const KNOWLEDGE_BASE = [
        ...
        { keywords: /\b(resume|cv|curriculum vitae|bio-data|profile|download)\b/gi, answer: "You can view Harsha's professional roadmap in his resume: <div class='chat-action-buttons'><a href='resume.pdf' target='_blank' class='chat-btn email'>Download Resume</a></div>" },
